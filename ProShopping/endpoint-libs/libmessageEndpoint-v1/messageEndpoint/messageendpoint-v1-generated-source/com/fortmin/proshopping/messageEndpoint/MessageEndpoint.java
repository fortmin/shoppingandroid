...
public class MessageEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "enviarMensaje".
   *
   * This request holds the parameters needed by the the messageEndpoint server.  After setting any
   * optional parameters, call the {@link EnviarMensaje#execute()} method to invoke the remote
   * operation.
   *
   * @param message
   * @param usuario
   * @return the request
   */
  public EnviarMensaje enviarMensaje(java.lang.String message, java.lang.String usuario) throws java.io.IOException {
    EnviarMensaje result = new EnviarMensaje(message, usuario);
    initialize(result);
    return result;
  }

  public class EnviarMensaje extends MessageEndpointRequest<Void> {

    private static final String REST_PATH = "enviar_mensaje";
     ...
     * This request holds the parameters needed by the the messageEndpoint server.  After setting any
     * optional parameters, call the {@link EnviarMensaje#execute()} method to invoke the remote
     * operation. <p> {@link EnviarMensaje#initialize(com.google.api.client.googleapis.services.Abstra
     ...
     * @since 1.13
     */
    protected EnviarMensaje(java.lang.String message, java.lang.String usuario) {
    ...
    @Override
    public EnviarMensaje setAlt(java.lang.String alt) {
      return (EnviarMensaje) super.setAlt(alt);
    }

    @Override
    public EnviarMensaje setFields(java.lang.String fields) {
      return (EnviarMensaje) super.setFields(fields);
    }

    @Override
    public EnviarMensaje setKey(java.lang.String key) {
      return (EnviarMensaje) super.setKey(key);
    }

    @Override
    public EnviarMensaje setOauthToken(java.lang.String oauthToken) {
      return (EnviarMensaje) super.setOauthToken(oauthToken);
    }

    @Override
    public EnviarMensaje setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (EnviarMensaje) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public EnviarMensaje setQuotaUser(java.lang.String quotaUser) {
      return (EnviarMensaje) super.setQuotaUser(quotaUser);
    }

    @Override
    public EnviarMensaje setUserIp(java.lang.String userIp) {
      return (EnviarMensaje) super.setUserIp(userIp);
    }
    ...
    public EnviarMensaje setMessage(java.lang.String message) {
    ...
    public EnviarMensaje setUsuario(java.lang.String usuario) {
      this.usuario = usuario;
      return this;
    }

    @Override
    public EnviarMensaje set(String parameterName, Object value) {
      return (EnviarMensaje) super.set(parameterName, value);
    }
  }
