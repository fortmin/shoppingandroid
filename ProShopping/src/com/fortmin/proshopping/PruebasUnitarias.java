...
public class PruebasUnitarias extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		BDElementoRf bdElemRf1 = new BDElementoRf("BEACON001","BEACON",20,"MundialAbrigado");
		BDElementoRf bdElemRf2 = new BDElementoRf("NFC001","NFC",20,"MundialRuidoso");
		...
		dl.obtenerBaseLectura(getApplicationContext());
		if (dl.hasElementoRf("BEACON001")) Log.i("FER","Tiene el BEACON001");
		else Log.i("FER","No tiene el BEACON001");
		if (dl.hasElementoRf("NFC001")) Log.i("FER","Tiene el NFC001");
		else Log.i("FER","No tiene el NFC001");
		dl.cerrarBase();
		...
		Log.i("FER","encontreElementoRf con "+bdElemRf2.getElementoRf()+" devolvio "+resp);
		bdElemRf1.setRssi(40);
		resp = dl.encontreElementoRf(getApplicationContext(), bdElemRf1);
		Log.i("FER","encontreElementoRf con "+bdElemRf1.getElementoRf()+" devolvio "+resp);
